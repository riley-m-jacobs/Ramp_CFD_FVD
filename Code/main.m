...
out.Mfs = 2;              % Mach number incoming free stream flow
...
out.method = 'HLLE';      % Roe or HLLE
out.CFLmax = 0.9;         % CFL condition --> max starting
out.sanity = false;
...
out.mach_bot = false;              % Plot the mach along bottom
